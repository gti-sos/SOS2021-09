var app = (function () {
    ...
    /* src\budgetsAPI\frontend\App.svelte generated by Svelte v3.37.0 */

    const { console: console_1 } = globals;
    const file = "src\\budgetsAPI\\frontend\\App.svelte";
    ...
    // (40:12) {#each budgets as budget}
    function create_each_block(ctx) {
    	let tr;
    	let td0;
    	let t0_value = /*budget*/ ctx[2].center + "";
    	let t0;
    	let t1;
    	let td1;
    	let t2_value = /*budget*/ ctx[2].year + "";
    	let t2;
    	let t3;
    	let td2;
    	let t4_value = /*budget*/ ctx[2].fixed_fees + "";
    	let t4;
    	let t5;
    	let td3;
    	let t6_value = /*budget*/ ctx[2].amounts_by_number_of_etc + "";
    	let t6;
    	let t7;
    	let td4;
    	let t8_value = /*budget*/ ctx[2].amounts_by_number_of_proffessors + "";
    	let t8;
    	let t9;
    	let td5;
    	let t10_value = /*budget*/ ctx[2].total + "";
    	let t10;
    	let t11;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*budgets*/ 1 && t0_value !== (t0_value = /*budget*/ ctx[2].center + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*budgets*/ 1 && t2_value !== (t2_value = /*budget*/ ctx[2].year + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*budgets*/ 1 && t4_value !== (t4_value = /*budget*/ ctx[2].fixed_fees + "")) set_data_dev(t4, t4_value);
    			if (dirty & /*budgets*/ 1 && t6_value !== (t6_value = /*budget*/ ctx[2].amounts_by_number_of_etc + "")) set_data_dev(t6, t6_value);
    			if (dirty & /*budgets*/ 1 && t8_value !== (t8_value = /*budget*/ ctx[2].amounts_by_number_of_proffessors + "")) set_data_dev(t8, t8_value);
    			if (dirty & /*budgets*/ 1 && t10_value !== (t10_value = /*budget*/ ctx[2].total + "")) set_data_dev(t10, t10_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(40:12) {#each budgets as budget}",
    		ctx
    	});
