var app = (function () {
    ...
    /* src\cargonare1\frontend\App.svelte generated by Svelte v3.37.0 */

    const { console: console_1 } = globals;
    const file = "src\\cargonare1\\frontend\\App.svelte";
    ...
    // (40:12) {#each surrenders as surrender}
    function create_each_block(ctx) {
    	let tr;
    	let td0;
    	let t0_value = /*surrender*/ ctx[2].degree + "";
    	let t0;
    	let t1;
    	let td1;
    	let t2_value = /*surrender*/ ctx[2].year + "";
    	let t2;
    	let t3;
    	let td2;
    	let t4_value = /*surrender*/ ctx[2].surrender_counts + "";
    	let t4;
    	let t5;
    	let td3;
    	let t6_value = /*surrender*/ ctx[2].new_students + "";
    	let t6;
    	let t7;
    	let td4;
    	let t8_value = /*surrender*/ ctx[2].surrender_percent + "";
    	let t8;
    	let t9;
    	let td5;
    	let t10_value = /*surrender*/ ctx[2].center + "";
    	let t10;
    	let t11;
    	...
    	const block = {
    		c: function create() {
    			...
    			t10 = text(t10_value);
    			t11 = space();
    			add_location(td0, file, 41, 20, 1185);
    			add_location(td1, file, 42, 20, 1231);
    			add_location(td2, file, 43, 20, 1275);
    			add_location(td3, file, 44, 20, 1325);
    			add_location(td4, file, 45, 20, 1389);
    			add_location(td5, file, 46, 20, 1461);
    			add_location(tr, file, 40, 16, 1159);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*surrenders*/ 1 && t0_value !== (t0_value = /*surrender*/ ctx[2].degree + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*surrenders*/ 1 && t2_value !== (t2_value = /*surrender*/ ctx[2].year + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*surrenders*/ 1 && t4_value !== (t4_value = /*surrender*/ ctx[2].surrender_counts + "")) set_data_dev(t4, t4_value);
    			if (dirty & /*surrenders*/ 1 && t6_value !== (t6_value = /*surrender*/ ctx[2].new_students + "")) set_data_dev(t6, t6_value);
    			if (dirty & /*surrenders*/ 1 && t8_value !== (t8_value = /*surrender*/ ctx[2].surrender_percent + "")) set_data_dev(t8, t8_value);
    			if (dirty & /*surrenders*/ 1 && t10_value !== (t10_value = /*surrender*/ ctx[2].center + "")) set_data_dev(t10, t10_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(40:12) {#each surrenders as surrender}",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	let t11;
    	let tbody;
    	let each_value = /*surrenders*/ ctx[0];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td0, file, 30, 16, 811);
    			add_location(td1, file, 31, 16, 844);
    			add_location(td2, file, 32, 16, 874);
    			add_location(td3, file, 33, 16, 913);
    			add_location(td4, file, 34, 16, 975);
    			add_location(td5, file, 35, 16, 1034);
    			add_location(tr, file, 29, 12, 789);
    			add_location(thead, file, 28, 8, 768);
    			add_location(tbody, file, 38, 8, 1095);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*surrenders*/ 1) {
    				each_value = /*surrenders*/ ctx[0];
    				validate_each_argument(each_value);
    				let i;
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 25, 0, 692);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	async function getsurrenders() {
    		...
    		const res = await fetch("/api/v1/surrenders-by-centers-us/surrenders");

    		if (res.ok) {
    			console.log("Ok.");
    			const json = await res.json();
    			$$invalidate(0, surrenders = json);
    	...
    	$$self.$inject_state = $$props => {
    		if ("surrenders" in $$props) $$invalidate(0, surrenders = $$props.surrenders);
    	};
