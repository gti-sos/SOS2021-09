var app = (function () {
    ...
    // (168:16) <Input type="select" bind:value={searchConfig.limit} on:change={() => {searchConfig.page = 1}}>
    function create_default_slot_15$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option0, file$2, 168, 20, 5747);
    			option1.__value = "10";
    			option1.value = option1.__value;
    			add_location(option1, file$2, 169, 20, 5787);
    			option2.__value = "25";
    			option2.value = option2.__value;
    			add_location(option2, file$2, 170, 20, 5828);
    			option3.__value = "50";
    			option3.value = option3.__value;
    			add_location(option3, file$2, 171, 20, 5869);
    			option4.__value = "100";
    			option4.value = option4.__value;
    			add_location(option4, file$2, 172, 20, 5910);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(168:16) <Input type=\\\"select\\\" bind:value={searchConfig.limit} on:change={() => {searchConfig.page = 1}}>",
    		ctx
    	});
    ...
    function create_default_slot_14$1(ctx) {
    	...
    	function input_value_binding_6(value) {
    		/*input_value_binding_6*/ ctx[22](value);
    	}
    	...
    	if (/*searchConfig*/ ctx[1].limit !== void 0) {
    		input_props.value = /*searchConfig*/ ctx[1].limit;
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_value && dirty[0] & /*searchConfig*/ 2) {
    				updating_value = true;
    				input_changes.value = /*searchConfig*/ ctx[1].limit;
    				add_flush_callback(() => updating_value = false);
    			}
    ...
    function create_default_slot_9$1(ctx) {
    	...
    	function click_handler_2() {
    		return /*click_handler_2*/ ctx[30](/*index*/ ctx[42]);
    	}
    	...
    	function click_handler_3() {
    		return /*click_handler_3*/ ctx[31](/*index*/ ctx[42]);
    	}
    ...
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			create_component(formgroup.$$.fragment);
    			t12 = space();
    			add_location(td0, file$2, 203, 20, 7465);
    			add_location(td1, file$2, 204, 20, 7523);
    			add_location(td2, file$2, 205, 20, 7564);
    			add_location(td3, file$2, 206, 20, 7624);
    			add_location(td4, file$2, 207, 20, 7678);
    			add_location(td5, file$2, 208, 20, 7734);
    			add_location(td6, file$2, 209, 20, 7777);
    			add_location(tr, file$2, 202, 16, 7439);
    			this.first = tr;
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_8$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(th0, file$2, 181, 16, 6107);
    			add_location(th1, file$2, 182, 16, 6155);
    			add_location(th2, file$2, 183, 16, 6185);
    			add_location(th3, file$2, 184, 16, 6223);
    			add_location(th4, file$2, 185, 16, 6268);
    			add_location(th5, file$2, 186, 16, 6316);
    			add_location(th6, file$2, 187, 16, 6349);
    			add_location(tr0, file$2, 180, 12, 6085);
    			add_location(thead, file$2, 179, 12, 6064);
    			add_location(td0, file$2, 192, 20, 6472);
    			add_location(td1, file$2, 193, 20, 6606);
    			add_location(td2, file$2, 194, 20, 6708);
    			add_location(td3, file$2, 195, 20, 6837);
    			add_location(td4, file$2, 196, 20, 6967);
    			add_location(td5, file$2, 197, 20, 7102);
    			add_location(td6, file$2, 198, 20, 7209);
    			add_location(tr1, file$2, 191, 16, 6446);
    			add_location(tbody, file$2, 190, 12, 6421);
    		},
    		m: function mount(target, anchor) {
    ...
    // (225:20) <Button class="btn-light bg-transparent" on:click={() => searchConfig.page--}>
    function create_default_slot_6$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(225:20) <Button class=\\\"btn-light bg-transparent\\\" on:click={() => searchConfig.page--}>",
    		ctx
    	});
    ...
    // (227:20) <Button class="btn-light bg-transparent" on:click={() => searchConfig.page++}>
    function create_default_slot_4$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(227:20) <Button class=\\\"btn-light bg-transparent\\\" on:click={() => searchConfig.page++}>",
    		ctx
    	});
    ...
    function create_default_slot_3$1(ctx) {
    	...
    	button0.$on("click", /*click_handler_4*/ ctx[32]);
    	...
    	button1.$on("click", /*click_handler_5*/ ctx[33]);
    ...
    function create_default_slot_2$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 222, 12, 8271);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*searchConfig, data*/ 3 | dirty[1] & /*$$scope*/ 32768) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function input_value_binding_6(value) {
    		if ($$self.$$.not_equal(searchConfig.limit, value)) {
    	...
    	const change_handler = () => {
    		$$invalidate(1, searchConfig.page = 1, searchConfig);
    	};
    	...
    	const click_handler_4 = () => $$invalidate(1, searchConfig.page--, searchConfig);
    	const click_handler_5 = () => $$invalidate(1, searchConfig.page++, searchConfig);
    ...
    function create_default_slot_18(ctx) {
    	...
    	const block = {
    		c: function create() {
    			b = element("b");
    			b.textContent = "Campo de conocimiento";
    			add_location(b, file$1, 66, 27, 2383);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, b, anchor);
    		},
    ...
    function create_default_slot_16(ctx) {
    	...
    	const block = {
    		c: function create() {
    			b = element("b");
    			b.textContent = "Año";
    			add_location(b, file$1, 70, 27, 2597);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, b, anchor);
    		},
    ...
    function create_default_slot_14(ctx) {
    	...
    	const block = {
    		c: function create() {
    			b = element("b");
    			b.textContent = "Rendimiento";
    			add_location(b, file$1, 74, 27, 2778);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, b, anchor);
    		},
    ...
    function create_default_slot_12(ctx) {
    	...
    	const block = {
    		c: function create() {
    			b = element("b");
    			b.textContent = "Créditos superados";
    			add_location(b, file$1, 78, 27, 2984);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, b, anchor);
    		},
    ...
    function create_default_slot_10(ctx) {
    	...
    	const block = {
    		c: function create() {
    			b = element("b");
    			b.textContent = "Créditos matriculados";
    			add_location(b, file$1, 82, 27, 3193);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, b, anchor);
    		},
    ...
    function create_default_slot_8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			b = element("b");
    			b.textContent = "Centro";
    			add_location(b, file$1, 86, 27, 3407);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, b, anchor);
    		},
