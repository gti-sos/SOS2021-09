var app = (function () {
    ...
    /* src\fraferbla1\frontend\App.svelte generated by Svelte v3.37.0 */

    const { console: console_1 } = globals;
    const file = "src\\fraferbla1\\frontend\\App.svelte";
    ...
    // (40:12) {#each cuts as cut}
    function create_each_block(ctx) {
    	let tr;
    	let td0;
    	let t0_value = /*cut*/ ctx[2].degree + "";
    	let t0;
    	let t1;
    	let td1;
    	let t2_value = /*cut*/ ctx[2].year + "";
    	let t2;
    	let t3;
    	let td2;
    	let t4_value = /*cut*/ ctx[2].cut_off_mark + "";
    	let t4;
    	let t5;
    	let td3;
    	let t6_value = /*cut*/ ctx[2].selectivity_presented_seville + "";
    	let t6;
    	let t7;
    	let td4;
    	let t8_value = /*cut*/ ctx[2].price_admision + "";
    	let t8;
    	let t9;
    	let td5;
    	let t10_value = /*cut*/ ctx[2].faculty + "";
    	let t10;
    	let t11;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*cuts*/ 1 && t0_value !== (t0_value = /*cut*/ ctx[2].degree + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*cuts*/ 1 && t2_value !== (t2_value = /*cut*/ ctx[2].year + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*cuts*/ 1 && t4_value !== (t4_value = /*cut*/ ctx[2].cut_off_mark + "")) set_data_dev(t4, t4_value);
    			if (dirty & /*cuts*/ 1 && t6_value !== (t6_value = /*cut*/ ctx[2].selectivity_presented_seville + "")) set_data_dev(t6, t6_value);
    			if (dirty & /*cuts*/ 1 && t8_value !== (t8_value = /*cut*/ ctx[2].price_admision + "")) set_data_dev(t8, t8_value);
    			if (dirty & /*cuts*/ 1 && t10_value !== (t10_value = /*cut*/ ctx[2].faculty + "")) set_data_dev(t10, t10_value);
    		},
    		d: function destroy(detaching) {
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			td2 = element("td");
    			td2.textContent = "Nota de corte";
    			t5 = space();
    			td3 = element("td");
    			td3.textContent = "Alumnos presentados en selectividad";
    			t7 = space();
    			td4 = element("td");
    			td4.textContent = "Precio de matrícula";
    			t9 = space();
    			td5 = element("td");
    			td5.textContent = "Facultad";
    			t11 = space();
    			tbody = element("tbody");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h3 = element("h3");
    			h3.textContent = "Notas de corte por curso";
    			t1 = space();
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("cuts" in $$props) $$invalidate(0, cuts = $$props.cuts);
    	};
