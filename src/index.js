...
app.use(express_1["default"].json()); // Automatically parses the requests body into a JSON
app.use(express_1["default"].static('public')); // Exposes the folder public in the webapp
...
// Dani
app.get('/info/performances-by-degrees-us', function (req, res) {
...
// Adri
app.get('/info/budgets-by-centers-us', function (req, res) {
