...
var db_ab = new Datastore({ filename: 'dbs/surrendersdb' });
...
// Index page.
router.get("/", (req, res) => {
	res.send('<html><body><h1> Hi!</h1> <br> <h3> This is the API home page: "surrenders by degree US". Please, load <a href="http://sos2021-09.herokuapp.com">the initial data</a> to display the information.</h3></body><html>');
...
router.put("/surrenders/:degree/:year", function (req, res) {
   ...
   */
		db_ab.update({ $and: [{ degree: Udegree }, { year: Uyear }] }, {
			...
			center: updatedSurrender.center
		}, (err, numSurrendersUpdated) => {
