<script>
    ...
    async function searchSurrenders(newSurrender) {
        ...
        if (newSurrender.degree != "")
            ruta = ruta + "degree=" + newSurrender.degree;
        if (newSurrender.year != "") ruta = ruta + "&year=" + newSurrender.year;
        if (newSurrender.surrender_counts != "")
            ruta = ruta + "&surrender_counts=" + newSurrender.surrender_counts;
        if (newSurrender.new_students != "") {
            ruta = ruta + "&new_students=" + newSurrender.new_students;
        }
        if (newSurrender.surrender_percent != "") {
            ruta =
                ruta + "&surrender_percent=" + newSurrender.surrender_percent;
        }
        if (newSurrender.center != "")
            ruta = ruta + "&center=" + newSurrender.center;
